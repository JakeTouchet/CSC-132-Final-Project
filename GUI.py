...
def main():
    ...
    ttk.Button(topFrame, text = 'Start', command = lambda: channel.basic_publish(exchange='GUI', routing_key='control', body='start')).grid(row=3, column=0, sticky = E, ipady = 3, pady = (0, 50))
    ttk.Button(topFrame, text = "Stop", command = lambda: channel.basic_publish(exchange='GUI', routing_key='control', body='stop')).grid(row= 3, column = 2, sticky = W, ipady = 3, pady = (0, 50))
